...
namespace Comps.ServiceLayer.Security
{
    public interface IApplicationUserManager : IDisposable
    {
        ...
        /// <summary>
        /// Find a user by his phoneNumber
        /// </summary>
        ...
        Task<ClaimsIdentity> GenerateUserIdentityAsync(ApplicationUser applicationUser, string authenticationType);
        Task<bool> HasPassword(int userId);
        Task<bool> HasPhoneNumber(int userId);
        void SeedDatabase();
        Task<List<ApplicationUser>> GetAllUsersAsync();
        Task<List<ApplicationUser>> GetAllUsersAsync(int skip, int pageSize);
        Task<List<ApplicationUser>> GetAllUsersAsync(string  name);
        IQueryable<ApplicationUser> GetUsers();
 
       Task<bool> IsValid(ApplicationUser user);
