...
namespace Camps.WebUI.Controllers.MVC
{
    ...
    public class AccountController : Controller
    {
        ...
        {
       //     Token token = new Token("admin@example.com", "09307185332");
        //  Response.Headers.Add("X-TOKEN", token.Encrypt()); 
            ViewBag.ReturnUrl = returnUrl;
            return View();
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await _signInManager.PasswordSignInAsync(model.UserName.Trim(),model.Password.Trim(), model.RememberMe, shouldLockout: false);
           // var result = await _signInManager.PasswordSignInAsync("admin@example.com", "Admin@123456", model.RememberMe, shouldLockout: false);
