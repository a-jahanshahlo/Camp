        ...
        return {
            ...
            link: function (scope, element, attrs, ngModel) {
                ...
                scope.parseInputValue = function (valueStr, resetTime, releaseTheBeast) {
                    ...
                    if (_dateTime) {
                        scope.dtpValue = {};
                        scope.dtpValue.year = _dateTime.year || _dateTime.getFullYear();
                        scope.dtpValue.month = _dateTime.month || _dateTime.getMonth() + 1;
                        scope.dtpValue.day = _dateTime.day || _dateTime.getDate();
                        scope.dtpValue.unix = _dateTime.unix || _dateTime.getTime();
                        scope.dtpValue.fullDate = _dateTime.gDate || _dateTime;
